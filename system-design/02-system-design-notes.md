...
More Robust CI CD
![robust CI CD](assets/ci-cd-2.svg)
...
- Cache Ratio = Cache Hits / (Cache Hits + Cache Miss)
  ...
  ![cache hit miss](assets/cache-hit-miss.svg)
...
![proxy request](assets/proxy-request.svg)
...
![server accessing information](assets/access-information-by-server.svg)
...
Downtime = 8760 hours_ (1 - 0.999) = 8760 hours \* 0.001 = 8.76 hours
